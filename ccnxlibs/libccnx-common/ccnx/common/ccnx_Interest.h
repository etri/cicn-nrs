...
CCNxName *ccnxInterest_GetKeyName(const CCNxInterest *interest);
...
//by wschoi
bool ccnxInterest_SetPayload_lookup(CCNxInterest *interest, const PARCBuffer *payload);


//REGISTRATION
#if 0
//refresh
bool ccnxInterest_SetPayload_refresh_key(CCNxInterest *interest, const PARCBuffer *payload);
bool ccnxInterest_SetPayload_refresh_value(CCNxInterest *interest, const PARCBuffer *payload);
#endif

//dereg
bool ccnxInterest_SetPayload_dereg_key(CCNxInterest *interest, const PARCBuffer *payload);
bool ccnxInterest_SetPayload_dereg_value(CCNxInterest *interest, const PARCBuffer *payload);

//del
bool ccnxInterest_SetPayload_del_key(CCNxInterest *interest, const PARCBuffer *payload);
bool ccnxInterest_SetPayload_del_value(CCNxInterest *interest, const PARCBuffer *payload);

//add
bool ccnxInterest_SetPayload_add_key(CCNxInterest *interest, const PARCBuffer *payload);
bool ccnxInterest_SetPayload_add_value(CCNxInterest *interest, const PARCBuffer *payload);

bool ccnxInterest_SetPayload_reg_key(CCNxInterest *interest, const PARCBuffer *payload);
bool ccnxInterest_SetPayload_reg_value(CCNxInterest *interest, const PARCBuffer *payload);
...
//by wschoi
bool ccnxInterest_SetPayloadWithId_lookup(CCNxInterest *interest, const PARCBuffer *payload, const CCNxInterestPayloadId *payloadId);
...
//LOOKUP TYPE
PARCBuffer *ccnxInterest_GetPayload_lookup(const CCNxInterest *interest);

PARCBuffer *ccnxInterest_GetPayload_KeyName(const CCNxInterest *interest);

//REGISTRATION TYPE
//registration
PARCBuffer *ccnxInterest_GetPayload_reg_key(const CCNxInterest *interest);
PARCBuffer *ccnxInterest_GetPayload_reg_value(const CCNxInterest *interest);

//update
PARCBuffer *ccnxInterest_GetPayload_add_key(const CCNxInterest *interest);
PARCBuffer *ccnxInterest_GetPayload_add_value(const CCNxInterest *interest);

//delete
PARCBuffer *ccnxInterest_GetPayload_del_key(const CCNxInterest *interest);
PARCBuffer *ccnxInterest_GetPayload_del_value(const CCNxInterest *interest);

//replace
PARCBuffer *ccnxInterest_GetPayload_dereg_key(const CCNxInterest *interest);
PARCBuffer *ccnxInterest_GetPayload_dereg_value(const CCNxInterest *interest);
#if 0
