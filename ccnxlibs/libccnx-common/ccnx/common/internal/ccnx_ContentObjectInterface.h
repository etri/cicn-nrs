...
typedef struct ccnx_contentobject_interface {
	...
	//by wschoi
	//LOOKUP
    CCNxTlvDictionary  *(*createWithNameAndPayload_lookup)(const CCNxName * contentName,
                                                    const CCNxPayloadType contentType,
                                                    const PARCBuffer * payload);
//REGISTRATION
	//reg
    CCNxTlvDictionary  *(*createWithNameAndPayload_reg_ack)(const CCNxName * contentName,
                                                    const CCNxPayloadType contentType,
                                                    const PARCBuffer * payload);

//add

    CCNxTlvDictionary  *(*createWithNameAndPayload_reg_add_ack)(const CCNxName * contentName,
                                                    const CCNxPayloadType contentType,
                                                    const PARCBuffer * payload);
//del
    CCNxTlvDictionary  *(*createWithNameAndPayload_reg_del_ack)(const CCNxName * contentName,
                                                    const CCNxPayloadType contentType,
                                                    const PARCBuffer * payload);

//dereg
    CCNxTlvDictionary  *(*createWithNameAndPayload_reg_dereg_ack)(const CCNxName * contentName,
                                                    const CCNxPayloadType contentType,
                                                    const PARCBuffer * payload);
