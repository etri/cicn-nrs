...
CCNxTlvDictionary *ccnxTlvDictionary_Acquire_1(const CCNxTlvDictionary *dictionary);
...
PARCBuffer *ccnxTlvDictionary_GetBuffer_lookup(const CCNxTlvDictionary *dictionary, uint32_t key);
