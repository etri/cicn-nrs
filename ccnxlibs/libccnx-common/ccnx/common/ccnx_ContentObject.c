...
//LOOKUP
	CCNxContentObject *
ccnxContentObject_CreateWithNameAndPayload_lookup(const CCNxName *contentName, const PARCBuffer *payload)
{
	return ccnxContentObject_CreateWithImplAndPayload_lookup(_defaultImplementation,
			contentName,
...
//LOOKUP
	CCNxContentObject *
ccnxContentObject_CreateWithImplAndPayload_lookup(const CCNxContentObjectInterface *impl,
		...
		const PARCBuffer *payload)
{
	...
	if (impl->createWithNameAndPayload != NULL) {
		if (contentName == NULL) {
			...
			result = impl->createWithNameAndPayload_lookup(contentName, payloadType, payload);
		}
...
//reg
	CCNxContentObject *
ccnxContentObject_CreateWithNameAndPayload_reg_ack(const CCNxName *contentName, const PARCBuffer *payload)
{
	const CCNxContentObjectInterface *impl=_defaultImplementation;
	const CCNxPayloadType payloadType=CCNxPayloadType_DATA;
	CCNxContentObject *result = NULL;


	if (contentName == NULL) {
		result = impl->createWithPayload(payloadType, payload);
		trapNotImplemented("ccnxContentObject_CreateWithNameAndPayload_ack(), contentName is NULL!");
	} else {
#ifdef LOG_CHECK
		printf("ccnxContentObject_CreateWithNameAndPayload_reg_ack()\n");
#endif
		result = impl->createWithNameAndPayload_reg_ack(contentName, payloadType, payload);
	}
	ccnxTlvDictionary_SetMessageInterface(result, impl);
	ccnxContentObject_SetPathLabel(result, 0);
	return result;
...
//add
	...
	CCNxContentObject *
ccnxContentObject_CreateWithNameAndPayload_add_ack(const CCNxName *contentName, const PARCBuffer *payload)
{
	const CCNxContentObjectInterface *impl=_defaultImplementation;
	const CCNxPayloadType payloadType=CCNxPayloadType_DATA;
	CCNxContentObject *result = NULL;
...
#ifdef LOG_CHECK
		printf("ccnxContentObject_CreateWithNameAndPayload_reg_add_ack()\n");
#endif
		result = impl->createWithNameAndPayload_reg_add_ack(contentName, payloadType, payload);
	}
	ccnxTlvDictionary_SetMessageInterface(result, impl);
	ccnxContentObject_SetPathLabel(result, 0);
	return result;
...
//del
	...
	CCNxContentObject *
ccnxContentObject_CreateWithNameAndPayload_del_ack(const CCNxName *contentName, const PARCBuffer *payload)
{
	const CCNxContentObjectInterface *impl=_defaultImplementation;
	const CCNxPayloadType payloadType=CCNxPayloadType_DATA;
	CCNxContentObject *result = NULL;
...
#ifdef LOG_CHECK
		printf("ccnxContentObject_CreateWithNameAndPayload_reg_del_ack()\n");
#endif
		result = impl->createWithNameAndPayload_reg_del_ack(contentName, payloadType, payload);
	}
	ccnxTlvDictionary_SetMessageInterface(result, impl);
	ccnxContentObject_SetPathLabel(result, 0);
	return result;
...
//dereg
	CCNxContentObject *
ccnxContentObject_CreateWithNameAndPayload_dereg_ack(const CCNxName *contentName, const PARCBuffer *payload)
{
	const CCNxContentObjectInterface *impl=_defaultImplementation;
	const CCNxPayloadType payloadType=CCNxPayloadType_DATA;
	CCNxContentObject *result = NULL;
...
#ifdef LOG_CHECK
		printf("ccnxContentObject_CreateWithNameAndPayload_reg_dereg_ack()\n");
#endif
		result = impl->createWithNameAndPayload_reg_dereg_ack(contentName, payloadType, payload);
	}
	ccnxTlvDictionary_SetMessageInterface(result, impl);
	ccnxContentObject_SetPathLabel(result, 0);
	return result;
...
//by wschoi
	PARCBuffer *
ccnxContentObject_GetPayload_lookup(const CCNxContentObject *contentObject)
{
	ccnxContentObject_OptionalAssertValid(contentObject);
	CCNxContentObjectInterface *impl = ccnxContentObjectInterface_GetInterface(contentObject);
	...
	if (impl->getPayload != NULL) {
		result = impl->getPayload_lookup(contentObject);
	} else {
