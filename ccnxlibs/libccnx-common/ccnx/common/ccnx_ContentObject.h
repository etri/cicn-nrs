...
//by wschoi
//LOOKUP
CCNxContentObject *ccnxContentObject_CreateWithNameAndPayload_lookup(const CCNxName *contentName,
                                                              const PARCBuffer *payload);
//REGISTRATION
//reg
CCNxContentObject *ccnxContentObject_CreateWithNameAndPayload_reg_ack(const CCNxName *contentName, const PARCBuffer *payload);
CCNxContentObject *ccnxContentObject_CreateWithNameAndPayload_reg_add_ack(const CCNxName *contentName, const PARCBuffer *payload);
CCNxContentObject *ccnxContentObject_CreateWithNameAndPayload_reg_del_ack(const CCNxName *contentName, const PARCBuffer *payload);
CCNxContentObject *ccnxContentObject_CreateWithNameAndPayload_reg_dereg_ack(const CCNxName *contentName, const PARCBuffer *payload);
...
CCNxContentObject *ccnxContentObject_CreateWithImplAndPayload_lookup(const CCNxContentObjectInterface *implementation,
                                                              const CCNxName *contentName,
                                                              const CCNxPayloadType type,
                                                              const PARCBuffer *payload);
...
PARCBuffer *ccnxContentObject_GetPayload_lookup(const CCNxContentObject *contentObject);
/**
