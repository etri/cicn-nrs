...
typedef enum rta_tlv_schema_v1_ccnxmessage_types {
	...
	//LOOKUP TYPE
	CCNxCodecSchemaV1Types_CCNxMessage_T_GETNAME = 0x0111,
	CCNxCodecSchemaV1Types_CCNxMessage_T_PAYLOAD_GETNAME = 0x0112,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_KEY = 0x0113,

//REGISTRATION TYPE
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_REGISTRATION_KeyName = 0x0114,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_REGISTRATION_ValueName = 0x0115,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_REGISTRATION_ACK = 0x0116,

	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_ADD_KeyName = 0x0117,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_ADD_ValueName = 0x0118,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_ADD_ACK = 0x0119,

	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_DEL_KeyName = 0x0120,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_DEL_ValueName = 0x0121,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_DEL_ACK = 0x0122,

	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_DEREG_KeyName = 0x0123,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_DEREG_ValueName = 0x0124,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_DEREG_ACK = 0x0125,
#if 0
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_REFRESH_KeyName = 0x0126,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_REFRESH_ValueName = 0x0127,
	CCNxCodecSchemaV1Types_CCNxMessage_T_NAME_REFRESH_ACK = 0x0128,
#endif
...
typedef enum rta_tlv_schema_v1_link_types {
    ...
    CCNxCodecSchemaV1Types_Link_T_NAME_REGISTRATION_KeyName = 0x0003,
    CCNxCodecSchemaV1Types_Link_T_NAME_REGISTRATION_ValueName = 0x0004,
