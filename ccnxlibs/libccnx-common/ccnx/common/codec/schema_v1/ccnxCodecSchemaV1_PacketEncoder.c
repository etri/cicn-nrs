...
//	printf("#############ccnxCodecSchemaV1PacketEncoder_DictionaryEncode\n\n");
...
{
//by wschoi
//	printf("#############ccnxCodecSchemaV1PacketEncoder_Encode\n\n");
    ssize_t length = -1;
...
//by wschoi
//	printf("#############ccnxCodecSchemaV1PacketEncoder_Encode, going to _encodeMessage\n\n");
