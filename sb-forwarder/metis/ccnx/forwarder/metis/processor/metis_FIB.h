...
bool metisRCT_AddOrUpdate(MetisRCT *rct, const uint8_t *newNameA, const unsigned newNameA_size, const uint8_t *newNameB, const unsigned newNameB_size);

MetisRCT *metisRCT_Match(MetisRCT *rct, const uint8_t *NameA, const  unsigned NameA_size);
#endif
