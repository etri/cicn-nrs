...
//#define MetisTlvSkeleton_ArrayLength 15
#define MetisTlvSkeleton_ArrayLength 24
...
/**
 * Sets the Payload extent
 *
 * Sets the payload extent to the specified offset and length.
 *
 ...
 */
//by wschoi
void metisTlvSkeleton_SetPayload(MetisTlvSkeleton *skeleton, size_t offset, size_t length);
void metisTlvSkeleton_SetGetname(MetisTlvSkeleton *skeleton, size_t offset, size_t length);
void metisTlvSkeleton_SetPayloadGetname(MetisTlvSkeleton *skeleton, size_t offset, size_t length);
void metisTlvSkeleton_SetKeyname(MetisTlvSkeleton *skeleton, size_t offset, size_t length);
void metisTlvSkeleton_SetRegistration(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
void metisTlvSkeleton_SetRegistration_add(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
void metisTlvSkeleton_SetRegistration_del(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
void metisTlvSkeleton_SetRegistration_dereg(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);

void metisTlvSkeleton_SetRegname(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
void metisTlvSkeleton_SetReg_Add_name(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
void metisTlvSkeleton_SetReg_Del_name(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
void metisTlvSkeleton_SetReg_Dereg_name(MetisTlvSkeleton *skeleton,
		size_t offset, size_t length);
...
//by wschoi
MetisTlvExtent metisTlvSkeleton_GetPayloadName(const MetisTlvSkeleton *skeleton);
MetisTlvExtent metisTlvSkeleton_GetGetname(const MetisTlvSkeleton *skeleton);
MetisTlvExtent metisTlvSkeleton_GetPayloadGetname(const MetisTlvSkeleton *skeleton);
MetisTlvExtent metisTlvSkeleton_GetKeyname(const MetisTlvSkeleton *skeleton);

MetisTlvExtent metisTlvSkeleton_GetKeyname(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetRegistration(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetRegistration_add(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetRegistration_del(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetRegistration_dereg(const MetisTlvSkeleton
                *skeleton);

MetisTlvExtent metisTlvSkeleton_GetRegname(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetReg_Add_name(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetReg_Del_name(const MetisTlvSkeleton
                *skeleton);
MetisTlvExtent metisTlvSkeleton_GetReg_Dereg_name(const MetisTlvSkeleton
                *skeleton);
